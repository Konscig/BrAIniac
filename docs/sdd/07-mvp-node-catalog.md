...
- Актуальным источником фактического runtime-поведения считать `./09-backend-runtime-truth-snapshot.md`.
- Этот документ сохраняет также исторические и baseline-разделы для контекста эволюции.
