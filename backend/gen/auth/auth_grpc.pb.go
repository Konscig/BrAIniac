...
type AuthServiceClient interface {
	Signin(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*LoginReply, error)
...
func (c *authServiceClient) Signin(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*LoginReply, error) {
...
type AuthServiceServer interface {
	Signin(context.Context, *SigninRequest) (*LoginReply, error)
...
func (UnimplementedAuthServiceServer) Signin(context.Context, *SigninRequest) (*LoginReply, error) {
