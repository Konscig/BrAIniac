...
var file_api_proto_depIdxs = []int32{
	...
	12, // 19: api.AgentGraphService.GetProject:input_type -> api.GetProjectRequest
	13, // 20: api.AgentGraphService.UpdateProject:input_type -> api.UpdateProjectRequest
	14, // 21: api.AgentGraphService.DeleteProject:input_type -> api.DeleteProjectRequest
	28, // 22: api.AgentGraphService.ListProjects:input_type -> google.protobuf.Empty
	27, // 23: api.Greeter.SayHello:output_type -> api.HelloReply
	10, // 24: api.AgentGraphService.CreateProject:output_type -> api.ProjectResponse
	15, // 25: api.AgentGraphService.CreatePipeline:output_type -> api.PipelineSummary
	4,  // 26: api.AgentGraphService.GetPipelineGraph:output_type -> api.GetPipelineGraphResponse
	1,  // 27: api.AgentGraphService.CreatePipelineNode:output_type -> api.PipelineNode
	1,  // 28: api.AgentGraphService.UpdatePipelineNode:output_type -> api.PipelineNode
	28, // 29: api.AgentGraphService.DeletePipelineNode:output_type -> google.protobuf.Empty
	2,  // 30: api.AgentGraphService.CreatePipelineEdge:output_type -> api.PipelineEdge
	28, // 31: api.AgentGraphService.DeletePipelineEdge:output_type -> google.protobuf.Empty
	19, // 32: api.AgentGraphService.ListPipelines:output_type -> api.ListPipelinesResponse
	21, // 33: api.AgentGraphService.PublishPipelineVersion:output_type -> api.PublishPipelineVersionResponse
	24, // 34: api.AgentGraphService.ExecutePipeline:output_type -> api.ExecutePipelineResponse
	10, // 35: api.AgentGraphService.GetProject:output_type -> api.ProjectResponse
	10, // 36: api.AgentGraphService.UpdateProject:output_type -> api.ProjectResponse
	28, // 37: api.AgentGraphService.DeleteProject:output_type -> google.protobuf.Empty
