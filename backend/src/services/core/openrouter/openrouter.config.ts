...
export function getOpenRouterConfig(): OpenRouterConfig {
  ...
  cachedConfig = {
    ...
    apiKey,
    defaultChatModel: readTrimmed(process.env.OPENROUTER_LLM_MODEL) ?? 'openai/gpt-4o-mini',
    defaultEmbeddingModel: readTrimmed(process.env.OPENROUTER_EMBEDDING_MODEL) ?? 'openai/text-embedding-3-small',
